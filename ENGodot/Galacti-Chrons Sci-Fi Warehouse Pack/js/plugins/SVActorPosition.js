...
(function() {
  ...
  var SVActor7X = Number(parameters['actor7 Xpos'] || 1130);
  var SVActor1Y = Number(parameters['actor1 Ypos'] || 546);
  var SVActor2Y = Number(parameters['actor2 Ypos'] || 546);
  var SVActor3Y = Number(parameters['actor3 Ypos'] || 546);
  var SVActor4Y = Number(parameters['actor4 Ypos'] || 546);
  var SVActor5Y = Number(parameters['actor5 Ypos'] || 546);
  var SVActor6Y = Number(parameters['actor6 Ypos'] || 546);
  var SVActor7Y = Number(parameters['actor7 Ypos'] || 546);
  ...
  Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    if (command === 'SVActorPosition') {
      ...
      if(value){
        ...
        case '7':
          if(args[1] === 'x' || args[1] === 'X'){
            $gameSystem.svActorX[6] = value;
          } else if(args[1] === 'y'|| args[1] === 'Y'){
            $gameSystem.svActorY[6] = value;
          }
        }
      }
    }
  ...
  Game_System.prototype.defineSvActorArray = function() {
    this.svActorX = [null, null, null, null, null, null, null];
    this.svActorY = [null, null, null, null, null, null, null];
  };
